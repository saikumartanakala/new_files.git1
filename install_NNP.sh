...
echo "check the node installed or not"
echo "Node.js version $(node -v) installed successfully."
echo "check the npm installed or not"
echo "Npm version $(npm -v) installed successfully."
echo "check the php installed or not"
echo "Php version $(php -v) installed successfully."
